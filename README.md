PROJETO feito como atividade avaliativa para Front-End do Bootcamp da Labenu, onde o aluno deve desenvolver, usando o React, um e-commerce de artigos espaciais seguindo os requisitos apresentados abaixo.
